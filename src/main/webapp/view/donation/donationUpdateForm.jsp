...
<form class="w3-container w3-card-4" enctype = "multipart/form-data" action = "${pageContext.request.contextPath}/donation/boardUpdatePro" method="post"
style = "padding : 2rem">
<h3   class="w3-center">기부정보 등록</h3>
<br>

	<input type = "text" name = "index_num" value = "${board.index_num}"/>
